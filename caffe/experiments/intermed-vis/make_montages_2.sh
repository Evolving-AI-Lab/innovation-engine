...
function crop_montage_text() {
    ...
    if [ "`ls -rt *best_X.jpg montage.jpg | tail -n 1`" = "montage.jpg" ]; then
...
layerdir=results/150203_212645_2468771_priv_paper_all/$layer/$layer

for hsdir in `ls -d $layerdir/unit*/hs*`; do
