...
#include "phen/phen_color_image_crop.hpp"
...
struct Params
{
  ...
  // Specific settings for MNIST database of grayscale
	struct image : ParamsCaffe::image
	{
		...
		SFERES_CONST int canvas_size = 256;
...
const std::string Params::image::model_definition = "/home/anh/src/model/imagenet_deploy_memory_data_batch_1.prototxt";
...
int main(int argc, char **argv)
{
  ...
  typedef phen::ColorImageCrop<cppn_t, fit_t, Params> phen_t;
