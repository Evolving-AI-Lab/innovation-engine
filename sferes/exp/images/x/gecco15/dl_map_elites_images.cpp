...
const std::string Params::image::model_definition = "../../../../model/imagenet_deploy_memory_data.prototxt";
const std::string Params::image::pretrained_model = "../../../../model/caffe_reference_imagenet_model";
