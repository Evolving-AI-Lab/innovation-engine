...
#include "stat/stat_map_phylogenetic.hpp"
...
//		SFERES_CONST float m_rate_del_neuron = 0.04f;
  ...
  struct pop
  {
  	//number of initial random points
		static const size_t init_size = 1; // 1000
...
int Params::pop::dump_period = 250;		// Because we want
...
//  typedef boost::fusion::vector<stat::BestFit<phen_t, Params>, stat::MeanFit<Params> >  stat_t;
  typedef boost::fusion::vector<stat::MapImagePhylogeneticStat<phen_t, Params>, stat::BestFitMapImage<phen_t, Params> >  stat_t;
