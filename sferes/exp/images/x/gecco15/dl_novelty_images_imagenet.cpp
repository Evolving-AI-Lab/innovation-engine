...
#include "stat/pareto_front_image.hpp"
#include <sferes/modif/novelty.hpp>
#include <sferes/run.hpp>


// Evolutionary algorithms --------------------------------
#include "fit/fit_novelty_deep_learning.hpp"
...
struct Params
{
	...
	struct novelty
	{
		SFERES_CONST float rho_min_init = 0.6;
		SFERES_CONST size_t k = 8;
		SFERES_CONST size_t stalled_tresh = 50;
  ...
  // Specific settings for MNIST database of grayscale
	struct image : ParamsCaffe::image
	{
		...
		SFERES_CONST int image_dump_period = 500;	// MNIST has 10 categories
	};
...
int main(int argc, char **argv)
{
  ...
  // this file.
	typedef sferes::fit::FitNoveltyDeepLearning<Params> fit_t;
...
//  typedef eval::Eval<Params> eval_t;
  ...
  typedef boost::fusion::vector<stat::ParetoFrontImage<phen_t, Params> >  stat_t;
